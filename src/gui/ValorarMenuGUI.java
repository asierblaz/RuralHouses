...
import domain.*;
public class ValorarMenuGUI extends JFrame {
	...
	public ValorarMenuGUI() {
		...
		JLabel lblVerDatosDe = new JLabel("Valorar Casa");
		lblVerDatosDe.setFont(new Font("Tahoma", Font.PLAIN, 18));
		lblVerDatosDe.setBounds(162, 13, 210, 16);
