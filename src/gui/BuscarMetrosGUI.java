...
public class BuscarMetrosGUI extends JFrame {
	...
	public BuscarMetrosGUI() {
		...
		JLabel lblBuscarCasaPor = new JLabel("Buscar Casa por Metros");
		...
		textField.setBounds(111, 59, 40, 22);
		...
		rhs = facade.getRuralHouseByMetros(m);
		if(NoHayDatos()){
			dispose();
		}
		// combobox
