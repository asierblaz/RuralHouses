...
public class QueryAvailabilityGUI extends JFrame {
	...
	private final JButton btnReservar = new JButton(
			ResourceBundle.getBundle("Etiquetas").getString("QueryAvailabilityGUI.btnReservar.text")); //$NON-NLS-1$ //$NON-NLS-2$
	...
	private void jbInit() throws Exception {
		...
		this.setSize(new Dimension(435, 660));
		...
		jButton1.setBounds(new Rectangle(55, 532, 130, 30));
		...
		jButton2.setBounds(new Rectangle(235, 532, 130, 30));
		...
		btnReservar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				String noches = jTextField3.getText();
				if (!ComprobarCamposVacios()){

				JFrame reserva = new VerOffersGUI(rh, noches);
				reserva.setVisible(true); }
			}
		});
		btnReservar.setBounds(154, 479, 97, 25);

		getContentPane().add(btnReservar);

		if (MainGUI.getUsuario() instanceof Users) {
	...
	private boolean ComprobarCamposVacios() {
		String message = "Porfavor rellene el numero de noches";
